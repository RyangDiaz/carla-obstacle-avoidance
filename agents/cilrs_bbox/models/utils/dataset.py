...
'''
    Dataloader for loading expert trajectories and training trajectories created
...
class CilrsDataset(Dataset):
    def __init__(self, list_expert_h5, list_dagger_h5, env_wrapper, im_augmenter=None):
        ...
        if env_wrapper.view_augmentation:
            self._obs_keys_to_load = ['speed', 'gnss', 'bbox', 'lanes', 'central_rgb', 'left_rgb', 'right_rgb']
        else:
            self._obs_keys_to_load = ['speed', 'gnss', 'bbox', 'lanes', 'central_rgb']
