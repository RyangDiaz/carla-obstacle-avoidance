...
class RlBirdviewWrapper(gym.Wrapper):
    ...
    def reset(self, seed=None, options=None):
        ...
        obs_ma, _, _, _, _ = self.env.step(action_ma)
    ...
    def step(self, action):
        ...
        obs_ma, reward_ma, terminated_ma, truncated_ma, info_ma = self.env.step(action_ma)

        obs = self.process_obs(obs_ma[self._ev_id], self._input_states)
        reward = reward_ma[self._ev_id]
        terminated = terminated_ma[self._ev_id]
        truncated = truncated_ma[self._ev_id]
