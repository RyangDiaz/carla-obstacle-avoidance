...
class CarlaMultiAgentEnv(gym.Env):
    ...
    def __init__(self, carla_map, host, port, seed, no_rendering,
                 obs_configs, reward_configs, terminal_configs, all_tasks, render_mode=None):
    ...
    def step(self, control_dict):
        ...
        reward_dict, terminated_dict, info_dict = self._ev_handler.tick(self.timestamp)
        truncated_dict = {k: False for k in terminated_dict.keys()}
