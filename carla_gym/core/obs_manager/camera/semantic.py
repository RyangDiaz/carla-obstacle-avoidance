...
# TODO: Change to semantic

class ObsManager(ObsManagerBase):
    """
    Template configs:
    obs_configs = {
        "module": "camera.instance_segmentation",
        "location": [-5.5, 0, 2.8],
        "rotation": [0, -15, 0],
        "frame_stack": 1,
        "width": 1920,
    ...
    def __init__(self, obs_configs):
        ...
        self._sensor_type = 'camera.instance_segmentation'
    ...
    def _define_obs_space(self):
        ...
        self.obs_space = spaces.Dict({
            ...
            'data': spaces.Box(
                low=0, high=100, shape=(self._height, self._width, self._channels), dtype=np.uint8)
        })
    ...
    def get_observation(self):
        ...
        try: 
            ...
            raise Exception('Semantic sensor took too long!')
