...
def lbc_hazard_vehicle(obs_surrounding_vehicles, ev_speed=None, proximity_threshold=9.5, up_angle_th=45):
    for i, is_valid in enumerate(obs_surrounding_vehicles['binary_mask']):
        ...
        with_distance_ahead = is_within_distance_ahead(sv_loc, proximity_threshold, up_angle_th=up_angle_th) # 45
