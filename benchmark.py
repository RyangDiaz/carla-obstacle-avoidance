...
def run_single(run_name, env, agents_dict, agents_log_dir, log_video, max_step=None):
    ...
    while not done['__all__']:
        ...
        obs, reward, terminated, truncated, info = env.step(control_dict)
...
def main(cfg: DictConfig):
    ...
    print("[DEBUG] Killing Carla potentially")
    if cfg.kill_running:
    ...
    terminal_configs = {}
    agent_names = []
    print("[DEBUG] Configuring actors...")
    ...
    print("[DEBUG] Checking birdview maps...")
    ...
    print("[DEBUG] Looping through routes")
    for task_idx in tqdm(range(ckpt_task_idx, env.num_tasks)):
